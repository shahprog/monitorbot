...
class MyHelpCommand(commands.HelpCommand):
    ...
    async def send_cog_help(self, cog):
        ...
        embed = discord.Embed(
            title=f"Help for category `{cog.qualified_name}`", description=msg
        )
    ...
    async def send_command_help(self, command):
        ...
        embed = discord.Embed(title=f"Help for command `{command}`", description=msg)
    ...
    async def send_group_help(self, group):
        ...
        embed = discord.Embed(
            title=f"Help for group `{group.qualified_name}`", description=msg
        )
